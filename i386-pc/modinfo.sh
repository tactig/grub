...
# Build environment
grub_target_cc='gcc'
grub_target_cc_version='gcc (GCC) 4.9.1 20140903 (prerelease)'
...
grub_target_cppflags=' -Wall -W -I$(top_srcdir)/include -I$(top_builddir)/include  -DGRUB_MACHINE_PCBIOS=1 -DGRUB_MACHINE=I386_PC -m32 -nostdinc -isystem /usr/lib/gcc/i686-pc-linux-gnu/4.9.1/include'
